...
O Capítulo 13 do SWEBOK-AI v5.0 redefine completamente o conceito de Software
Security para a era dos LLMs. Enquanto o SWEBOK v4.0 focava em vulnerabilidades
tradicionais (OWASP Top 10, buffer overflows, injeção de SQL), a versão 5.0
reconhece que **a superfície de ataque expandiu-se dramaticamente com a
introdução de vulnerabilidades específicas de IA, ataques a cadeias de
suprimentos de modelos, e novas classes de exploits que exploram comportamentos
estocásticos**.

Este capítulo apresenta os fundamentos, ameaças e práticas para segurança
quando: (1) código gerado por IA pode conter vulnerabilidades não-intencionais
ou "alucinadas"; (2) prompts são vetores de ataque (prompt injection,
jailbreaking); (3) modelos e embeddings são componentes críticos da cadeia de
suprimentos; e (4) ataques adversariais exploram comportamentos
não-determinísticos.

O foco desloca-se de "proteger código escrito por humanos contra ameaças
conhecidas" para "proteger sistemas híbridos contra ameaças tradicionais E
ameaças emergentes específicas de IA".
...
- 40% das aplicações com LLM têm vulnerabilidades de prompt injection (Gartner,
  2025\)
- Código gerado por IA tem taxa similar de vulnerabilidades de segurança (Pearce
  et al., arXiv 2025)
...
01. **LLM01: Prompt Injection** — Injeção de instruções maliciosas
02. **LLM02: Insecure Output Handling** — Processamento inseguro de outputs
03. **LLM03: Training Data Poisoning** — Envenenamento de dados de treino
04. **LLM04: Model Denial of Service** — Consumo excessivo de recursos
05. **LLM05: Supply Chain Vulnerabilities** — Vulnerabilidades na cadeia
06. **LLM06: Sensitive Information Disclosure** — Vazamento de dados sensíveis
07. **LLM07: Insecure Plugin Design** — Plugins inseguros
08. **LLM08: Excessive Agency** — Permissões excessivas para LLM
09. **LLM09: Overreliance** — Confiança excessiva em outputs
...
- **Resumo:** Lista das 10 principais vulnerabilidades em aplicações com LLMs.
  Diretrizes, exemplos, mitigações.
...
- **Autores:** NIST (2025)
- **Resumo:** Framework abrangente de gestão de risco de IA. Governança,
  mapeamento, medição, gestão.
...
- **Resumo:** Requisitos regulatórios da UE para segurança de sistemas de IA.
...
- **Título:** "An Empirical Study of Security Vulnerabilities in Code Generated
  by Large Language Models"
- **Autores:** Pearce et al. (2025)
- **Resumo:** Estudo empírico de vulnerabilidades em código gerado por LLMs.
  Taxas, tipos, CWEs.
...
- **Título:** "Asleep at the Keyboard? Assessing the Security of GitHub
  Copilot's Code Contributions"
- **Autores:** Pearce et al. (atualização 2024)
- **Resumo:** Análise de vulnerabilidades em código gerado pelo Copilot. 40% de
  snippets vulneráveis.
...
- **Resumo:** Como ferramentas SAST detectam vulnerabilidades em código de IA.
  Limitações.
...
- **Resumo:** Levantamento completo de ataques de prompt injection. Técnicas,
  detecção, defesa.
...
- **Título:** "Indirect Prompt Injection Attacks in Retrieval-Augmented
  Generation"
- **Autores:** Pesquisa acadêmica (2025)
- **Resumo:** Ataques de injeção indireta via dados recuperados em RAG. Vetores,
  defesas.
...
- **Resumo:** Guia de segurança da cadeia de suprimentos de IA. Modelos, dados,
  APIs.
...
- **Resumo:** Análise de ataques à cadeia de suprimentos de modelos. Poisoning,
  trojans.
...
- **Resumo:** Práticas recomendadas para defender contra prompt injection.
...
- **Resumo:** Panorama de ferramentas de firewall para LLMs. Comparativos,
  capacidades.
...
- **Resumo:** Técnicas de sandboxing para execução segura de código gerado por
  LLMs.
...
- **Autores:** NIST (2025)
- **Resumo:** Framework prático para avaliação de risco de segurança em sistemas
  com IA.
...
- **Resumo:** Guia para desenvolver políticas de segurança para uso de
  ferramentas de IA.
...
- **Autores:** OWASP (2025)
- **Resumo:** Práticas de codificação segura ao usar assistentes de IA.
  Treinamento.
...
- **Resumo:** Relatório anual sobre estado da segurança de IA. Ameaças,
  vulnerabilidades, tendências.
...
*Documento de planejamento - SWEBOK-AI v5.0 - Capítulo 13* *Total de
