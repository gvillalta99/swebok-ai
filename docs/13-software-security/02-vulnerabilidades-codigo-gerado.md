...
1. **Pearce, H. et al.** "An Empirical Study of Security Vulnerabilities in Code Generated by Large Language Models". arXiv preprint, 2025.
2. **Pearce, H. et al.** "Asleep at the Keyboard? Assessing the Security of GitHub Copilot's Code Contributions". IEEE S&P, 2024.
3. **SonarSource.** "Security Analysis of AI-Generated Code: Challenges and Solutions". 2025. Disponível em: <https://www.sonarsource.com/blog/security-analysis-ai-code-2025>.
