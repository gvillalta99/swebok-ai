...
> > *"Quando a geração de código torna-se instantânea e barata, a atividade crítica torna-se a verificação de que código gerado atende a requisitos, respeita restrições, e não introduz falhas invisíveis."*
...
**Quando usar**: Decisões arquiteturais, código de alta criticidade, revisões finais
...
1. [[03-principios-diretores-swebok-ai|Princípio 4: Verificação é o Novo Gargalo]]
2. [[05-software-testing/01-fundamentos-verificacao-sistemas-ia.md|Fundamentos de Verificação de Sistemas IA]]
3. [[05-software-testing/02-tecnicas-teste-codigo-gerado.md|Técnicas de Teste para Código Gerado]]
