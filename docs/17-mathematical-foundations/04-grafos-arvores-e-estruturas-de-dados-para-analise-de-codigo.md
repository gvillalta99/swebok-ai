...
Grafo e a representacao universal de dependencias: chamadas de funcao, imports, fluxo de dados, pacotes, permissao, e ate cadeia de evidencias de verificacao. Em engenharia com IA, grafos sustentam duas classes de necessidade:
...
Arvores e grafos derivados (AST, CFG, DFG) sao a base de analisadores, refatoradores, linters e verificadores que funcionam como "freios" para geracao automatica.

## Learning Objectives

Apos estudar esta secao, o leitor deve ser capaz de:

1. Diferenciar representacoes (AST, CFG, DFG, call graph, dependency graph) e seus usos
2. Aplicar algoritmos de grafos para analise de impacto, detecao de ciclos e ordenacao topologica
3. Usar arvores e travessias para transformacoes seguras de codigo
4. Entender limites e riscos de aproximacoes (grafos incompletos, reflexao, dinamismo)
5. Integrar grafos com pipelines de revisao e verificacao para codigo gerado por LLM
...
- aplicar politicas por camada (ex.: proibido acesso direto ao banco fora da camada X)
...
Para IA, AST e um "alvo" melhor do que texto: um modelo pode gerar um patch, mas a ferramenta valida que o patch respeita invariantes estruturais.
...
Representacoes em grafo tambem suportam modelos (por exemplo, GNNs) para tarefas de engenharia (localizacao de falhas, recomendacao de mudancas). Mesmo quando se usa ML, a modelagem grafica continua sendo a estrutura explicavel e auditavel.

## Practical Considerations

- Decida a "fonte de verdade" do grafo: build system, AST parser, runtime tracing.
- Documente aproximacoes: grafos estaticos falham com reflexao, dinamismo e metaprogramacao.
- Use grafos para limitar contexto fornecido a LLM (subgrafo relevante) e reduzir vazamento.
...
1. Cormen, T.; Leiserson, C.; Rivest, R.; Stein, C. Introduction to Algorithms. 4th ed. MIT Press, 2022.
...
4. arXiv. Deep Learning for Code Intelligence: Survey, Benchmark and Toolkit. 2024. https://arxiv.org/html/2401.00288v1
