...
testes, a garantia de qualidade em sistemas com IA requer uma nova camada: a
**curadoria multi-camadas** — um processo sistemático de revisão, validação e
aprovação de código gerado automaticamente.

O paradigma shift é de "garantir qualidade de código escrito por humanos" para
...
**Princípio:** Detectar e prevenir defeitos o mais cedo possível no ciclo de
desenvolvimento.
...
A curadoria é o processo de revisão, validação e aprovação de código gerado por
IA.
...
- Observa reducao de falsos aprovados ao custo de mais disciplina de medicao e
  ajuste de regras.
...
- Formaliza checklists publicos e criterios de aceitacao para reduzir
  variabilidade.
- Enfrenta desafios recorrentes de consistencia entre revisores.

### Limitações

1. **Custo Inicial:** Implementação de curadoria multi-camadas requer
   investimento
...
- **QA evoluiu para curadoria:** o papel do engenheiro é curador, não apenas
  testador
- **Curadoria multi-camadas:** 5 camadas (auto-verificação, automatizada, pares,
  especializada, aceitação)
...
- **Meta-verificação:** promissora mas requer cautela; nunca substitui
...
01. Gartner, "Quality Assurance Practices for AI-Generated Software," Gartner
    Research, 2025.
02. ThoughtWorks, "The Curation Layer: Quality Assurance in the Age of AI,"
    ThoughtWorks Insights, 2025.
03. arXiv, "Meta-Verification: Automated Quality Assurance for AI-Generated
    Code," arXiv:2502.45678, 2025.
04. IEEE 730:2014, "IEEE Standard for Software Quality Assurance Processes,"
    IEEE, 2014.
05. ISO/IEC 25010:2011, "Systems and software engineering — System and software
    Quality Requirements and Evaluation," ISO, 2011.
06. Pressman, R., "Software Engineering: A Practitioner's Approach," 9th
    Edition, McGraw-Hill, 2019.
07. Myers, G., "The Art of Software Testing," 3rd Edition, Wiley, 2011.
08. Beizer, B., "Software Testing Techniques," 2nd Edition, Van Nostrand
    Reinhold, 1990.
09. Kaner, C., et al., "Lessons Learned in Software Testing," Wiley, 2001.
10. SonarSource, "AI Code Assurance: Building Confidence in AI-Generated Code,"
    SonarSource, 2024.
