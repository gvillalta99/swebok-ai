...
governanca. A organizacao que nao treina essas competencias tende a acelerar
geracao e acumular risco.
...
4. Governanca: trilha de auditoria, politicas e segregacao de funcoes quando
   exigido.

## 6.2 Trilha de Formacao (Fases)

Fase 1 (fundamentos): conceitos, limites e responsabilidade. Fase 2
(verificacao): oraculos, testes e criterios de release. Fase 3 (governanca):
gates, auditoria e gestao de risco. Fase 4 (atualizacao): ciclos curtos de
aprendizagem com revisao de praticas.
...
3. Crie rituais de compartilhamento (postmortems, revisoes de padroes de
   prompt).
