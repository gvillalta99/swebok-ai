...
como blocos estruturais complementares. Esta seção apresenta a organização do
guia, o racional por trás das transformações e orientações para navegação
efetiva.

A estrutura preserva a fundamentação conceitual do SWEBOK v4.0 enquanto
...
1. Navegar a estrutura 00-16 do SWEBOK-AI e compreender o racional das
   transformações
...
### Reorganização para 15 KAs + blocos estruturais

O SWEBOK v4.0 organizava o conhecimento em 18 áreas. O SWEBOK-AI v5.0 consolida
para 15 KAs oficiais (01-15), além da Introdução (00) e do Apêndice de
referência (16):

**Fusões Estratégicas:**

- Software Design e Software Construction são tratados como aspectos
  interdependentes de um mesmo paradigma de curadoria
- Foundations são reorganizadas para refletir fundamentos de sistemas cognitivos
  artificiais
...
| 08  | Software Configuration Management          | Gestão de Configuração                    | Versionamento de código e contexto             |
...
| 16  | -                                          | Apêndice de Referências e Conformidade    | Glossário, matrizes e referências consolidadas |

## Mapeamento de Transformações

### KA 01: Requirements → Engenharia de Restrições e Contexto

**Transformação Fundamental:** De especificação de funcionalidades para
definição de limites e fronteiras dentro das quais agentes de IA operam.

**Racional:** No paradigma tradicional, requisitos especificavam o que o sistema
deveria fazer. No novo paradigma, o foco desloca-se para:
...
**Transformação Fundamental:** De design de sistemas determinísticos para
arquitetura de sistemas que incorporam componentes probabilísticos.

**Racional:** Sistemas modernos são híbridos por natureza: componentes
determinísticos coexistem com componentes de IA. A arquitetura deve endereçar:
...
**Transformação Fundamental:** De codificação manual para orquestração de
geração e curadoria de código.

**Racional:** A atividade central deixou de ser escrever código para ser:
...
**Transformação Fundamental:** De teste de sistemas determinísticos para
verificação de sistemas não-determinísticos.

**Racional:** Quando código é gerado por IA, testes tradicionais são
insuficientes:
...
**Transformação Fundamental:** De manutenção de código legado para gestão de
sistemas cuja lógica de raciocínio não está documentada.

**Racional:** Código gerado por IA apresenta desafios únicos:
...
**Transformação Fundamental:** De práticas profissionais estabelecidas para
exercício de julgamento sobre quando e como usar IA.

**Racional:** A profissão de engenheiro de software adquire novas dimensões
éticas e técnicas:
...
**Transformação Fundamental:** De análise de custo-benefício tradicional para
economia da abundância e escassez no contexto de IA.

**Racional:** As leis econômicas da engenharia de software foram reconfiguradas:
...
### Bloco 16: Apêndice de Referências e Conformidade

**Transformação Fundamental:** De um KA de fundamentos para um bloco de apoio
editorial, governança e conformidade.

**Racional:** Os fundamentos de IA foram incorporados na Introdução (00) e
distribuídos nos KAs aplicáveis. O bloco 16 concentra artefatos de referência:

- especificações editoriais;
- padrões ISO/IEC/IEEE;
- glossário e matrizes de conformidade;
- referências cruzadas consolidadas.

**Conexão com Princípios:**

- reforça rastreabilidade, padronização e auditabilidade do guia.
...
- Mapeamentos fundamentais: Requirements → Restrições, Design → Sistemas
  Híbridos, Construction → Orquestração, Testing → Verificação em Escala
- Cada transformação é fundamentada nos seis princípios diretores estabelecidos
  no KA 00
- A estrutura preserva conhecimento fundamental enquanto o recontextualiza para
  o novo paradigma
- Dependências entre KAs são explicitadas, permitindo navegação sequencial ou
...
2. IEEE Computer Society. (2024). "SWEBOK v4.0 — Software Engineering Body of
   Knowledge".
