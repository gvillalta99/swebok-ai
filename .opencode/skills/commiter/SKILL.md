...
Quando o usuário pedir para fazer commit ou quando você completar uma tarefa que exija commit, SIGA ESTRITAMENTE:
...
3. **Escreva o título**: `<tipo>[escopo]: <ação no imperativo presente, max 50 chars>`
...
6. **Execute**: Use `git commit` com a mensagem formatada ou mostre para o usuário confirmar.
...
- Se houver breaking change, adicione `!` após o tipo: `feat(api)!: remove campo deprecated`
