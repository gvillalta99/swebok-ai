...
[![Versão](https://img.shields.io/badge/Versão-5.0.0--beta-blue)](https://github.com/gvillalta99/swebok-ai)
...
**🌐 Acesse o site:** [https://gvillalta99.github.io/swebok-ai/](https://gvillalta99.github.io/swebok-ai/)
...
- **[📖 Leia Online](https://gvillalta99.github.io/swebok-ai/)** - Acesse a versão web completa
- **[📥 Baixar PDF](https://gvillalta99.github.io/swebok-ai/assets/swebok-ai.pdf)** - Versão para leitura offline
- **[⭐ GitHub](https://github.com/gvillalta99/swebok-ai)** - Código fonte e contribuições
...
### Reestruturação dos KAs Tradicionais

#### Software Requirements → **Engenharia de Restrições e Contexto**
...
#### Software Design → **Design de Sistemas Híbridos (Humanos-IA)**
...
#### Software Construction → **Orquestração e Curadoria de Código**
...
### Novos KAs Obrigatórios

1. **Engenharia de Garantia e Verificação em Escala** - O gargalo deixou de ser produção e passou a ser validação
2. **Governança de IA para Engenharia de Software** - Responsabilidade legal e alocação de culpa em falhas
3. **Engenharia de Manutenção de Sistemas Opaços** - Manutenção de código legado gerado por IA
4. **Economia e Métricas da Engenharia com IA** - Paradoxo de Jevons aplicado ao software
...
- 📝 [Contribuir com conteúdo](CONTRIBUTING.md)
...
- Participe das [discussões](https://github.com/gvillalta99/swebok-ai/discussions)
